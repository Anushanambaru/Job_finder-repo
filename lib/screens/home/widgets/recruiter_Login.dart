    ...
    if (formkey.currentState!.validate()) {
      ...
      try {
        ...
        if (user != null) {
          ...
          // Navigate to the job screen or any other screen after successful login
          Navigator.push(
            context,
            MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: Padding(
          padding: const EdgeInsets.fromLTRB(45, 150, 35, 0),
          child: SingleChildScrollView(
            child: Form(
              ...
              child: Column(
                children: [
                  Image.network(
                    'https://cdni.iconscout.com/illustration/premium/thumb/login-4571930-3805752.png',
                  ),
                  TextFormField(
