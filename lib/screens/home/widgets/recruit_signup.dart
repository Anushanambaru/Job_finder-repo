...
class _SignupPageState extends State<SignupPage> {
  ...
  bool confirmvisibility = true; final formkey = GlobalKey<FormState>();
            ...
            child: Column(
              children: [
                ...
                Padding( padding: const EdgeInsets.fromLTRB(30, 10, 30, 0),
                  child: Column(
                    children: [
                      Image.asset('assests/images/signup.jpg.webp', height: 150,),
                      SizedBox(height: 20),
                      Padding( padding: const EdgeInsets.fromLTRB(0, 20, 0, 0),
                        child: TextFormField( autovalidateMode: autovalidate,
                          ...
                          decoration: const InputDecoration( labelText: "EmailId", labelStyle: TextStyle(color: Colors.blueGrey),
                      ...
                      TextFormField( autovalidateMode: autovalidate,
                        ...
                        decoration: InputDecoration( hintText: "Enter Password",
                          ...
                          labelText: "Password", labelStyle: const TextStyle(color: Colors.blueGrey),
                          suffixIcon: IconButton( onPressed: () {
                            setState(() {
                              passwordVisibility = !passwordVisibility; });
                          },
                            icon: Icon( passwordVisibility ? Icons.visibility_off : Icons.visibility, color: Colors.blueAccent ),
                          ),
                      ...
                      const SizedBox( width: 150, height: 15, ),
                      TextFormField( autovalidateMode: autovalidate, controller: confirmtextEditingController, obscureText: confirmvisibility, validator: (String? cpass)
                      {
                        if (cpass!.length < 6) {
                          return 'password should be min 6 letters';
                        }
                        ...
                        ConfirmPassword = cpass; return null;
                      },
                        onSaved: (value) {
                        ...
                        decoration: InputDecoration( hintText: "Enter Confirm Password",
                          ...
                          suffixIcon: IconButton( onPressed: () {
                            ...
                            icon: Icon(confirmvisibility ? Icons.visibility_off : Icons.visibility),
                            color: Colors.blueAccent, ),
                          border: const OutlineInputBorder( borderSide: BorderSide( color: Color.fromARGB(255, 133, 236, 133), width: 0.1, ),
                            borderRadius: BorderRadius.only( topLeft: Radius.circular(15), bottomRight: Radius.circular(15), ),
                          ),
                          focusedBorder: const OutlineInputBorder( borderSide: BorderSide( color: Color(0xff018001), ),
                            borderRadius: BorderRadius.only( topLeft: Radius.circular(15), bottomRight: Radius.circular(15)),
                        ...
                        child: TextButton( onPressed: () async {
                          if (formkey.currentState!.validate()) {
                            if (Password == ConfirmPassword) {
                              ...
                              showSnackBar(errorMessage.toString(), Colors.red);
                              }
                            }
                            else { showSnackBar('Passwords didn\'t match', Colors.red); autovalidate = AutovalidateMode.always; }
                          }
                        },
                          style: TextButton.styleFrom( backgroundColor:  Colors.blue),
                          child: const Text( 'Create', style: TextStyle( color: Colors.white, fontSize: 20, fontWeight: FontWeight.w600, ),
                          ),
                        ),
                      ),
                    ],
